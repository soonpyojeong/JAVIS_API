...
var script15 = {
  ...
  computed: {
    ...
    dropdownIconDataP: function dropdownIconDataP() {
      return cn(_defineProperty2({}, this.size, this.size));
    },
    overlayDataP: function overlayDataP() {
      return cn(_defineProperty2({}, "portal-" + this.appendTo, "portal-" + this.appendTo));
    }
  },
  directives: {
    ripple: Ripple
...
script15.render = render3;

export {
  script14 as script,
  script15 as script2
};
//# sourceMappingURL=chunk-JNJLJXL7.js.map
