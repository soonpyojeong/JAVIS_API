import {
  ...
  script3 as script17,
  script4 as script18
} from "./chunk-DO4C4LOH.js";
import {
  script as script10
} from "./chunk-GXGCVUBG.js";
import {
  FocusTrap
} from "./chunk-XOQS5MYB.js";
import {
  script as script13,
  script2 as script14
} from "./chunk-JNJLJXL7.js";
import "./chunk-Q7Z3W5TQ.js";
import {
  FilterMatchMode,
  FilterOperator,
  FilterService
} from "./chunk-J3VH5YWM.js";
import {
  ConnectedOverlayScrollHandler,
  OverlayEventBus,
  _default,
  getVNodeProp
} from "./chunk-EU4BU2DJ.js";
import {
  script as script9
} from "./chunk-3QIRSL26.js";
import {
  script as script12
} from "./chunk-KC5VWG5N.js";
import {
  script as script11
} from "./chunk-IYVZ3NKJ.js";
import "./chunk-23ZQYHL4.js";
import {
  script as script5
} from "./chunk-BWSGY3Z4.js";
import {
  script as script4
} from "./chunk-HV2DLSAA.js";
import {
  script as script3
...
import {
  script as script7
} from "./chunk-6DRFV3MS.js";
import "./chunk-PW4G7HTW.js";
import {
  script as script2
} from "./chunk-ALPMY5UP.js";
import {
  script
...
var script$5 = {
  ...
  components: {
    ...
    Button: script5,
    Portal: script11,
    FilterSlashIcon: script26,
    FilterFillIcon: script25,
    FilterIcon: script24,
    TrashIcon: script28,
    PlusIcon: script27
  },
...
var script$2 = {
  ...
  computed: {
    ...
    sortableColumnIcon: function sortableColumnIcon() {
      ...
      if (!sorted2) return script16;
      else if (sorted2 && sortOrder2 > 0) return script18;
      else if (sorted2 && sortOrder2 < 0) return script17;
      return null;
    },
  ...
  methods: {
    ...
    resizeTableCells: function resizeTableCells(newColumnWidth, nextColumnWidth) {
      ...
      widths.forEach(function(width, index) {
        ...
        var style3 = "width: ".concat(colWidth, "px !important; max-width: ").concat(colWidth, "px !important");
    ...
    addColumnWidthStyles: function addColumnWidthStyles(widths) {
      ...
      var selector = '[data-pc-name="datatable"]['.concat(this.$attrSelector, '] > [data-pc-section="tablecontainer"] ').concat(this.virtualScrollerDisabled ? "" : '> [data-pc-name="virtualscroller"]', ' > table[data-pc-section="table"]');
      widths.forEach(function(width, index) {
        var style3 = "width: ".concat(width, "px !important; max-width: ").concat(width, "px !important");
        innerHTML += "\n        ".concat(selector, ' > thead[data-pc-section="thead"] > tr > th:nth-child(').concat(index + 1, "),\n        ").concat(selector, ' > tbody[data-pc-section="tbody"] > tr > td:nth-child(').concat(index + 1, "),\n        ").concat(selector, ' > tfoot[data-pc-section="tfoot"] > tr > td:nth-child(').concat(index + 1, ") {\n            ").concat(style3, "\n        }\n    ");
      });
      this.styleElement.innerHTML = innerHTML;
    },
    ...
    hasSpacerStyle: function hasSpacerStyle(style3) {
      return isNotEmpty(style3);
    }
  },
  computed: {
...
function render11(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.ptm("rowReorderIndicatorDown")), [(openBlock(), createBlock(resolveDynamicComponent(_ctx.$slots.rowreorderindicatordownicon || _ctx.$slots.reorderindicatordownicon || "ArrowUpIcon")))], 16)) : createCommentVNode("", true)], 16, _hoisted_12);
}
script29.render = render11;
export {
  script29 as default
};
